        ...
        <div class="container">
            ...
            <main>
                ...
                <div>
                    ...
                    <input id="txtidade" runat="server" type="number" min="17" max="100"/>
                </div>
                <div>
                    <asp:Label ID="Label3" runat="server" Text="RGM"></asp:Label>
                    <asp:TextBox ID="txtrgm" runat="server" minlength="8" maxlength="8"></asp:TextBox>
                    </div>
                <div>
                    <asp:Label ID="Label4" runat="server" Text="Curso"></asp:Label>
                    <asp:TextBox ID="txtcurso" runat="server" maxlength="10"></asp:TextBox>
                </div>
            </main>
